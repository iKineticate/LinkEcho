...
const CLEAN: &str = "M622 112c17.673 0 32 14.327 32 32l-0.001 139H879c17.673 0 32 14.327 32 32v164c0 17.673-14.327 32-32 32h-25.001L854 880c0 17.673-14.327 32-32 32H201c-17.673 0-32-14.327-32-32l-0.001-369H144c-17.673 0-32-14.327-32-32V315c0-17.673 14.327-32 32-32h224.999L369 144c0-17.673 14.327-32 32-32h221z m176 400H225v344h87.343V739.4c0-30.927 25.072-56 56-56V856h115.656L484 739.4c0-30.927 25.072-56 56-56l-0.001 172.6h115L655 739.4c0-30.927 25.072-56 56-56l-0.001 172.6H798V512z m49-165H176v100h671V347zM590 176H433v100h157V176z";
    ...
    if let Some(msgbox) = show_msgbox.read().clone() {
        ...
        rsx! {
            ...
            div {
                ...
                div { class: "msgbox-modal",
                    div {
                        class: "image",
                        background_color: msgbox.svg_back_color(),
                        svg { view_box: "0 0 1024 1024",
                            path { fill: msgbox.svg_fill(), d: msgbox.svg_d() }
                        }
                    }
                    div { margin_top: "0.75rem", text_align: "center",
                        p { class: "message", {msgbox.messages.clone()} }
                    }
                    button {
                        onclick: move |_| {
                            if let Some(action) = &is_warn {
                                match action {
                                    ...
                                    Action::ModyfyExeIcon => {
                                        if let Err(e) = modify_exe_icon() {
                                            error!("{e}");
